...
API_HASH = environ.get('API_HASH', '6907718633:AAH6WZPi83irCYI3VxAxkfcDh872ogcndLk')
BOT_TOKEN = environ.get('BOT_TOKEN', "6808668384:AAGKNPT24tLupcU_rKEys4JK-U3Yi2jLloc")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002029287584').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5597521952').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kantibhaipurohit195:nTA6VVaXfCu4h7L9@cluster0.htnhwwt.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002116913273'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'geniflix_group')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002023793554')).split()]
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'zu1xmKAMdlguQSBt5c8ais2aV212')
